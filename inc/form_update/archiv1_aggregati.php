...
<input type="hidden" id="tipo" name="tipo" value="<?php echo($campo); ?>" />
 ...
 <label>LIVELLO</label>
  <select id="archiv1_livello" name="archiv1_livello" class="form">
  ...
  <label>SCHEDA</label>
  <select id="archiv1_aggregato_update" name="archiv1_aggregato_update" class="form disabilitata" disabled="true">
       
  </select>
  <br/>
 <div class="login2" style="margin-top:20px;" id="archiv1_aggregati_salva">Salva</div>
