...
<div id="catalogo">
 ...
 <div class="filtro">
  <h1>PROGETTO</h1>
  <label for="progAll" class="labelCheck labelCheckActive pointer">
   <input type="radio" id="progAll" name="tipoProg" value="1" checked>
   ARCHIVIO ICONOGRAFICO 
  </label>
  <label for="progMiniere" class="labelCheck pointer">
   <input type="radio" id="progMiniere" name="tipoProg" value="5">
 ...
 <div class="filtro">
  ...
  <select id="locSel" class="selKeyWord">
   ...
   <?php
    ...
    $qcomexec=pg_query($connection, $qcom);
    while($arrcom = pg_fetch_array($qcomexec)){
     echo "<option value='".$arrcom['idlocalita']."'>".$arrcom['localita']."</option>";
    }
   ?>
  </select>
  <select id="indSel" class="selKeyWord">
   ...
   <?php
    ...
    $qcomexec=pg_query($connection, $qcom);
    while($arrcom = pg_fetch_array($qcomexec)){
     echo "<option value='".$arrcom['idindirizzo']."'>".$arrcom['indirizzo']."</option>";
    }
   ?>
  </select>
 </div>
